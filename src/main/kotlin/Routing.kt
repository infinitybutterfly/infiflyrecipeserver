...
//                    SimpleMessageResponse(false, e.message ?: "Email failed")
//                )
//            }
//        }
...
////            }
//
//            // 1. Receive and validate the request object
//            val request = try {
...
//            val formattedEmail = request.email.lowercase().trim()
//
//            // 2. Logic: If 'isValid' is true, update the database
//            if (request.isvalid) {
//                val userRow = transaction {
//                    Users.update({ Users.email eq formattedEmail }) {
//                        // Here you might set a 'verified' flag or clear the OTP
//                        it[Users.isVerified] = true
//                        it[Users.otpCode] = null // Optional: clear code after success
//                    }
//                }
//
//                if (userRow > 0) {
//                    call.respond(HttpStatusCode.OK, SimpleMessageResponse(true, "Email verified and saved."))
//                } else {
//                    call.respond(HttpStatusCode.NotFound, SimpleMessageResponse(false, "User not found."))
//                }
//            } else {
//                // 3. Handle the 'false' case
...
//            if (request.isvalid) {
            if (request.otp == "123456"){
                ...
                val profileData = UserProfile(
                    ...
                    isLocked = finalUser[Users.isPremium],
                    viewcount = finalUser[Users.freeViews]
                )
